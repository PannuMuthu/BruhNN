...
#
# Audio stretch. Takes arguments of audio stretch multiplier and 
# buffer before playing as number vals
# Ex: audioStretch(samplerate,smp,8.0,0.25,"out.wav")
...
def audioStretch(samplerate,smp,stretch,windowsize_seconds,outfilename):
...
(samplerate,smp)=load_wav("bruh.wav")

audioStretch(samplerate,smp,8.0,0.25,"stretchedBruh.wav")
